...
While looking for a framework to build our app, we found that they were too restrictive for our purposes so we built a library: [DeLib](https://www.npmjs.com/package/DeLib), which contains: 
