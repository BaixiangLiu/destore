...
<img alt="Signup-user" style="margin: 0 auto; float: left" src="./images/README/Signup-host.png" width="400"/> <img alt="Signup-user" style="margin: 0 auto" src="./images/README/Signup-user.png" width="400"/> 
